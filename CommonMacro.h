...
#ifndef TestApp_CommonMacro_h
#define TestApp_CommonMacro_h
...
#define IS_WIDESCREEN_6Plus                        (fabs((double)[[UIScreen mainScreen] bounds].size.height - (double)736) < __DBL_EPSILON__)                                 ([[[UIDevice currentDevice] model] isEqualToString: @"iPod touch"])
